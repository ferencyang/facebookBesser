    ...
    data() {
        ...
        methods: {
            getToken() {
                ...
                handleBeforeUpload() {
                    console.log('handleBeforeUpload操作')
                            ...
                            for (var i = 0; i < dateItems.length; i++) {
                                ...
                                if (dateItems[i].status === 1) {
                                    ...
                                    if (dateValCha > 0) {
                                        ...
                                        // console.log('timeVal值2：', dateValChaTwo);
                                        this.tapSubmitTwo(dateValNow, dateValChaTwo);
                                    } else {
                ...
                tapSubmit(dateValNow, timeVal) {
                    console.log("use:tapSubmit");
                    console.log('timeVal值2：', timeVal);
                    ...
                    if (network !== '200') {
                        ...
                        if (imei.length === 0) {
                            ...
                            console.log('uploadList数据', this.uploadList)
                            let multimedia = [];
                            for (var i = 0; i < this.uploadList.length; i++) {
                                ...
                                console.log('imgUrlByte数据', imgUrlByte)
                            ...
                            console.log('multimedia数据', multimedia)
                ...
                tapSubmitTwo(dateValNow, timeVal) {
                    console.log("use:tapSubmitTwo");
                    console.log('timeVal值2：', timeVal);
                    let network = window.sessionStorage.getItem('network');
