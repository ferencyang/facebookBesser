        ...
        <div class="header-form">
            <Form ref="formCustom" :model="formCustom" :rules="ruleCustom">
                ...
                <FormItem prop="password">
                    <Input type="password" icon="ios-locked-outline" v-model.trim="formCustom.password" :placeholder="$t('message.tipNewPassword')" style="width: 200px;"></Input>
                </FormItem>
                <FormItem prop="rePassword">
                    <Input type="password" icon="ios-locked-outline" v-model.trim="formCustom.rePassword" :placeholder="$t('message.tipConfirmPassword')" style="width: 200px;"></Input>
                </FormItem>
                <FormItem>
                    <Button type="primary" @click="handleSubmit('formCustom')" long style="width:200px;margin-top:5px;margin-bottom:15px;"> {{$t('message.labelRegister')}} </Button>
                </FormItem>
            </Form>
            <br />
                    ...
                    if (!mobileEnd) {
                        ...
                        this.axios({
                            ...
                            .then(response => {
                                console.log('返回的数据: ', response.data)
                                if (response.data.code === 200) {
                                    this.$Message.success(this.$t('message.tipSetPasswordSuccess'));
